...
def cancel_close_wifi_24G(app):
    if SET.set_app(app) ==1:
        if SET.click_wifi(app) ==1:
            if  SET.click_24Gwifi_switch(app,2) == 2:
                return 2

def close_wifi_24G(app):
    if SET.set_app(app) == 1:
        if SET.click_wifi(app) == 1:
            if  SET.click_24Gwifi_switch(app,1) == 1:
                return 1



class Test_24Gwifi_switch:
    def setup(self):
    ...
    def test_cancel_close_wifi_24G(self):
        assert cancel_close_wifi_24G(self.app) ==2

    def test_close_wifi_24G(self):
        assert close_wifi_24G(self.app) ==1
